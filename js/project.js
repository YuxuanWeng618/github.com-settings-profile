...
import {
  ...
  getProjectBySlug,
  getProjectNeighbors,
} from "./content.js?v=20260915d";
import { renderThemeToggle, bindThemeToggle, initTheme } from "./theme.js?v=20260915d";
import {
  getLang,
  renderLangToggle,
  bindLangToggle,
  initLang,
  updateHeaderContent,
} from "./lang.js?v=20260915d";
import { initHoverZoom } from "./zoom.js?v=20260915d";
